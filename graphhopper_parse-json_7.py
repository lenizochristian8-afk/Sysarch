...
key = "a7165d35-6383-44cd-b07d-4f6ce277403d"  # Replace with your Graphhopper API key
...
while True:
    ...
    if orig[0] == 200 and dest[0] == 200:
        ...
        if paths_status == 200:
            ...
            min_ = int(paths_data["paths"][0]["time"] / 1000 / 60 % 60)
            hr = int(paths_data["paths"][0]["time"] / 1000 / 60 / 60)

            print("Distance Traveled: {0:.1f} miles / {1:.1f} km".format(miles, km))
            print("Trip Duration: {0:02d}:{1:02d}:{2:02d}".format(hr, min_, sec))
            print("=================================================")
